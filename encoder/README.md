...
This directory (`encoder/`) contains the code of our two developed methods, as well as the data they use. This data has been extracted within the `../data_extraction/` directory.
